...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 09.00.14, July 04, 2023 07:10:17):
...
app_logger.info(f'Created July 04, 2023 07:10:17 at {str(current_path)}\n')
